...
public class ControlsSceneManager : MonoBehaviour
{
    ...
    private static ControlsSceneManager _instance;
    ...
    /// </summary>
    public static ControlsSceneManager Instance
    {
        get
        {
    ...
    /// cierre para evitar usar el ControlsSceneManager que podría haber sido
    ...
    public void GamePadControlsHUD(bool ver)
    {
        ...
        MainMenu.gameObject.SetActive(!ver);
        if (ver)
